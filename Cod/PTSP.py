...
VERSION = '1.0'
TIMESCALESIZE = 80  # = self.plot_timescale and self.plot_data_size
...
class Controls(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.plot_timescale_min = 0
        self.plot_timescale_max = 10000

        self.vertical_layout = QVBoxLayout(self)

        # Menu width:
        self.control_width = 130
...
class MainWindow(QWidget):
    ...
    def init_ui(self):
        ...
        self.setWindowTitle("PABFA - (T) Serial Plotter ")
        ...
        try:
            ...
            # Kui plot on olemas siis me ei skänni!
                ...
                with open("PORT.txt", "r") as f:
                    P = f.read()[0:4]
                    self.ports.append(P) # add devices to list
                    print(P)
    ...
    def about(self):
        ...
        self.aboutbox.setText("<center></center><b>PABFA EDITION - TSP</b><br/><br/>\
            Surce: <a href ='https://github.com/taunoe/tauno-serial-plotter'>\
            github.com/taunoe/tauno-serial-plotter</a><br/><br/>\
            Version {}<br/><br/>\
            Tauno Erik - PABFA EDITION <br/><br/>\
            2022-2023".format(VERSION))
        self.aboutbox.exec_()
    ...
    def open_serial(self):
            ...
            if self.ser.is_open:
                self.ser.close()
            self.ser = serial.Serial(PP[0:4],PP[5:9], timeout=0.09)
    ...
    def __init__(self, app, parent=None):
        ...
        self.baudrates = []
        with open("PORT.txt", "r") as f:
            self.baudrates.append(f.read()[5:9])
        self.default_baud_index = 0
        ...
        self.max_tryes = 100 # how_many_lines()
